...
function twentysixteen_scripts() {
	...
	wp_enqueue_script( 'twentysixteen-script', get_template_directory_uri() . '/js/lyquix.js', array( 'jquery' ), '20160412', true );
...
function lqx_add_pages() {
    ...
    add_submenu_page('themeoptions', __('Test Sublevel','menu-test'), __('Test Sublevel','menu-test'), 'manage_options', 'sub-page', 'lqx_sublevel_page');
