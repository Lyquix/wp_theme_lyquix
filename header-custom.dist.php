...
<head>
	...
	<?php endif;
	include('php/head-top.inc.php');
	include('php/css.inc.php');
	include('php/js.inc.php');
	include('php/favicon.inc.php');	
	include('php/head-bottom.inc.php');	
	?>
</head>
<?php
include('php/body-pre.inc.php');
?>
<body class="<?php echo ' ' . implode(' ', get_body_class()) . implode(',' , $body_classes); ?>">
<?php 
include('php/body-top.inc.php');	
?>	
