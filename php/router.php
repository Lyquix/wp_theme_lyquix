...
function tmpl_file_exists($tmpl_name) {
	return file_exists(get_stylesheet_directory() . '/php/custom/templates/' . $tmpl_name . '.php');
}
...
function render() {
	...
	elseif (is_archive()) {
		...
		// Custom router logic
		elseif (file_exists(get_stylesheet_directory() . '/php/custom/router.php')) {
	...
	if ($tmpl_name) {
		require get_stylesheet_directory() . '/php/custom/templates/' . $tmpl_name . '.php';
	}

	// Fallback to default templates
	else {
		if (is_home() || is_archive()) {
			if (tmpl_file_exists('archive')) require get_stylesheet_directory() . '/php/custom/templates/archive.php';
			else require get_template_directory() . '/php/archive.php';
		} elseif (is_singular()) {
			if (tmpl_file_exists('singular')) require get_stylesheet_directory() . '/php/custom/templates/singular.php';
